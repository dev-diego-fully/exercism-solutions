...
def tag_special_ingredients(dish):
    ...
    specials_in_dish = SPECIAL_INGREDIENTS.intersection(ingredients)
    return (dish_name, specials_in_dish)
...
def singleton_ingredients(dishes, intersection):    
    ...
    for ingredients in dishes:
        singletons = singletons.union(ingredients.difference(intersection))
    return singletons
