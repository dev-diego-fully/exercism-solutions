...
public class WeatherStation
{
    ...
    public Outlook ShortTermOutlook => reading switch
    {
        ...
        _ when reading.Pressure < 10m && reading.Temperature < 30 => Outlook.Cool,
    ...
    public Outlook LongTermOutlook => reading switch
    {
        _ when (reading.WindDirection == WindDirection.Southerly ||
            ...
            => Outlook.Good,
        _ when (reading.WindDirection == WindDirection.Northerly)
            => Outlook.Cool,
        _ when (reading.WindDirection == WindDirection.Easterly &&
                reading.Temperature <= 20)
            => Outlook.Warm,
        _ when (reading.WindDirection == WindDirection.Westerly)
            => Outlook.Rainy,
